    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://glitchtip.ragde.app/organizations/produtividade/issues/?project=2">Issues Page</a>.
